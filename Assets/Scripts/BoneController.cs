...
namespace UnityEngine.XR.ARFoundation.Samples
{
    public class BoneController : MonoBehaviour
    {
        ...
        public void ApplyBodyPose(ARHumanBody body)
        {
            ...
            bool[] detections = new bool[91];
            Vector3[] positions = new Vector3[91];
            Quaternion[] rotations = new Quaternion[91];
            ...
            for (int i = 0; i < k_NumSkeletonJoints; ++i)
            {
                ...
                SessionReceive.Joint3DBroadcastAll?.Invoke((detections, positions, rotations));
            }
        }
